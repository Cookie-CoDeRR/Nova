...
export function TopHeader({
  ...
  return (
    <header className="w-full py-4 px-4 sm:px-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-200 bg-white/90 backdrop-blur-md sticky top-0 z-40 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
      {/* Left: Personalized Greeting */}
      <div>
        <div className="flex items-center gap-2 text-[11px] font-bold font-mono uppercase tracking-wider text-purple-700 mb-0.5">
          <Sparkles className="w-3.5 h-3.5 text-purple-600" />
          <span>NOVA Digital Workspace</span>
        </div>
        <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-neutral-950 flex items-center gap-2 font-serif">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-neutral-200">
          <div className="w-9 h-9 rounded-full bg-black flex items-center justify-center font-bold text-xs text-white shadow-sm">
