    ...
    <GlassCard className="p-6 col-span-1 flex flex-col justify-between" glowColor="amber">
      <div className="flex items-center justify-between border-b border-neutral-100 pb-3 mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="font-serif text-base font-bold text-neutral-950 tracking-tight">Academic Companion</h2>
            <p className="text-xs text-neutral-500">Socratic practice metrics</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3 my-2">
        <div className="p-3.5 rounded-xl bg-purple-50 border border-purple-200 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-medium text-neutral-800">Socratic Questions Asked</span>
          </div>
        ...
        <div className="p-3.5 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-medium text-neutral-800">Syllabus Milestones Met</span>
          </div>
      ...
      <div className="pt-3">
        <Link
          href="/tutor"
          className="w-full py-3 rounded-xl font-bold text-xs bg-black text-white hover:bg-neutral-800 flex items-center justify-center gap-2 transition-all shadow-sm"
        >
