...
export default function StudyPulseDashboardPage() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-8 font-sans text-neutral-800 pb-16">
      ...
      {/* Header Banner matching Editorial Serif Landing Page DNA */}
      <div className="bg-white border border-neutral-200/80 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <button
          ...
          className={cn(
            "px-6 py-3.5 rounded-full font-bold text-xs shadow-sm flex items-center justify-center gap-2 transition-all duration-200 shrink-0 border",
            isReportLoading
              ? "bg-neutral-100 text-neutral-400 border-neutral-200 cursor-wait"
              : "bg-neutral-950 text-white hover:bg-neutral-800 border-black active:scale-[0.98]"
          )}
        >
          {isReportLoading ? (
            <>
      ...
      {/* Key Metric Cards matching Index Card Standard (bg-white border border-neutral-200/80 shadow-sm p-6) */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Total Focus Hours */}
        <div className="bg-white border border-neutral-200/80 rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-all duration-300">
      ...
      <div className="bg-white border border-neutral-200/80 rounded-2xl p-6 sm:p-8 shadow-sm space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-neutral-100 pb-4">
          <div>
            <h2 className="font-serif text-xl font-bold text-neutral-950 flex items-center gap-2">
          ...
          {/* Tooltip display */}
          <div className="text-xs font-mono bg-neutral-50 border border-neutral-200/80 rounded-lg px-3 py-1.5 text-neutral-700">
            {hoveredDay ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* Recharts Donut Card with Light Grid Lines (stroke="#f3f4f6") */}
        <div className="bg-white border border-neutral-200/80 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col justify-between space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-4 py-2">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip
                    ...
                    contentStyle={{ backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #e5e7eb', fontSize: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}
                  />
                </PieChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="space-y-2.5 text-xs font-medium">
              {MOCK_SUBJECT_BREAKDOWN.map((subject, idx) => (
                <div key={idx} className="flex items-center justify-between p-2.5 rounded-xl bg-neutral-50 border border-neutral-200/80">
        ...
        <div className="bg-white border border-neutral-200/80 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col justify-between space-y-4">
          ...
          <div className="space-y-4 my-2">
            <div>
              ...
              <div className="w-full h-4 bg-neutral-100 border border-neutral-200/80 rounded-full overflow-hidden p-0.5">
                <div
            ...
            <div className="space-y-2 text-xs">
              <span className="text-[10px] font-mono font-bold uppercase text-neutral-400 block tracking-wider">
